...
// No lugar de valor usamos null, pois o objeto Pessoa contém todos os atributos necessários.
		...
		assertEquals(
				"[(Pessoa {nome=J, idade=20},null), (Pessoa {nome=F, idade=25},null), (Pessoa {nome=M, idade=30},null)]",
				P.toString());
...
// No lugar de valor usamos null, pois o objeto Pessoa contém todos os atributos necessários.
		...
		assertEquals(
				"[(Pessoa {nome=F, idade=25},null), (Pessoa {nome=J, idade=20},null), (Pessoa {nome=M, idade=30},null)]",
				P.toString());
