...
// Retorna o nodo que segue um dado nodo da lista. 
	public Position<E> next(Position<E> p) throws InvalidKeyException, BoundaryViolationException;

// Retorna o nodo que antecede um dado nodo da lista. 
	public Position<E> prev(Position<E> p) throws InvalidKeyException, BoundaryViolationException;
