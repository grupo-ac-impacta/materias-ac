...
public class Index {
		...
		while (optionSelected != 0) {
			...
			case 1:
				System.out.println("\n Uma lista de nodos é uma coleção S de N elementos\n "
						+ "armazenados em uma certa ordem linear, é mais natural e eficiente \n"
						+ "usar um nodo em vez de um índice como forma de identificar \n"
						+ "onde acessar ou atualizar essa lista.\n "
			...
			case 10:
				System.out.println(
						"O método prev retorna a posição do elemento que precede o que se encontra na posição p. \n"
			...
			case 12:
				System.out.println(
						"O método next retorna a posição do elemento que segue o que se encontra na posição p. \n"
	...
	public void listElements() {
		System.out.println("• Elemento atual: " + (this.current != null ? this.current.element() : "null")
				+ (this.current == this.lista.first() ? " (primeiro)" : ""));
		System.out.println("• Elemento anterior: " + (this.prev != null ? this.prev.element() : "null")
				+ (this.prev == this.lista.first() ? " (primeiro)" : ""));
		System.out.println("• Próximo elemento: " + (this.next != null ? this.next.element() : "null")
