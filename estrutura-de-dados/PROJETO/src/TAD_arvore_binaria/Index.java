...
public class Index {
	...
	private LinkedBinaryTree<Integer> tree = null;
	
	public Index() {
		this.tree = new LinkedBinaryTree<Integer>();
	}
...
//					this.tree.attach(element, T1, T2);
	...
	public static void listOptions() {
		...
		System.out.println("• Digite '1' para entender a estrutrura de dados Árvore Binária");
		System.out.println("• Digite '2' para entender o método addRoot(v)");
		System.out.println("• Digite '3' para executar o método addRoot(v)");
		System.out.println("• Digite '4' para entender o método insertLeft(e, v)");
		System.out.println("• Digite '5' para executar o método insertLeft(e, v)");
		System.out.println("• Digite '6' para entender o método insertRight(e, v)");
		System.out.println("• Digite '7' para executar o método insertRight(e, v)");
		System.out.println("• Digite '8' para entender o método remove(e)");
		System.out.println("• Digite '9' para executar o método remove(e)");
		System.out.println("• Digite '10' para entender o método attach(e, t1, t2)");
		System.out.println("• Digite '11' para executar o método attach(e, t1, t2)");
		System.out.println("• Digite '12' para entender o método hasLeft(e)");
		System.out.println("• Digite '13' para executar o método hasLeft(e)");
		System.out.println("• Digite '14' para entender o método hasRight(e)");
		System.out.println("• Digite '15' para executar o método hasRight(e)");
		System.out.println("• Digite '16' para entender o método isExternal(e)");
		System.out.println("• Digite '17' para executar o método isExternal(e)");
		System.out.println("• Digite '18' para entender o método isInternal(e)");
		System.out.println("• Digite '19' para executar o método isInternal(e)");
		System.out.println("• Digite '20' para entender o método isEmpty()");
		System.out.println("• Digite '21' para executar o método isEmpty()");
		System.out.println("• Digite '22' para entender o método positions()");
		System.out.println("• Digite '23' para executar o método positions()");
		System.out.println("==============================================================");
	}
