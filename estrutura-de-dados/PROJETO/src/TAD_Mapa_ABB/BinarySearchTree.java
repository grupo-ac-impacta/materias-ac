...
import interfaces.DefaultComparator;
...
// Exibe a expressão parentizada da árvore
	...
	// Método adicionado à classe BinarySearchTree<K, V>.

	// Realiza a reestruturação trinode. Assume que os nodos estão numa das

	// 4 formas de mapeamento. Retorna a nova raiz da subárvore reestruturada.
